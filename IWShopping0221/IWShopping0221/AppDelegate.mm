...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    AIQKeyboardManager *manager = [AIQKeyboardManager sharedManager];
    manager.enable = YES;
    ...
    BOOL ret = [_mapManager start:@"rLZSliu2YdOgLWRpuYTVR6rHnyxQsTYI" generalDelegate:self];
    if (!ret) {
...
//    [WXApi registerApp:@"wxb4ba3c02aa476ea1" withDescription:@"demo 2.0"];
    [WXApi registerApp:@"wxc65c6d55c30dbbac" withDescription:@"cn.sword.IWShopping"];
     ...
     */
    [ShareSDK registerApp:@"1d0e1671f75f8"
...
//                 break;
     ...
     {
         // appId = "wxc65c6d55c30dbbac";appSecret="2341067f38a341a890a7c6425213c7b2";
         switch (platformType)
         {
//             case SSDKPlatformTypeSinaWeibo:
...
//                 break;
                 // 微信
             case SSDKPlatformTypeWechat:
                 [appInfo SSDKSetupWeChatByAppId:@"wxc65c6d55c30dbbac"
                                       appSecret:@"2341067f38a341a890a7c6425213c7b2"];
                 break;
             case SSDKPlatformTypeQQ:
                 [appInfo SSDKSetupQQByAppId:@"1106027567"
                                      appKey:@"olaHZUpfMWJZMs2M"
                                    authType:SSDKAuthTypeBoth];
                 break;
//             case SSDKPlatformTypeRenren:
