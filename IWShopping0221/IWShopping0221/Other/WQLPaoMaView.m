...
- (instancetype)initWithFrame:(CGRect)frame withTitle:(NSString *)title
{
    ...
    if (self) {
        ...
        showContentView.backgroundColor = IWColor(250, 241, 219);
        ...
        myLable.text = title;
        myLable.textColor = IWColor(84, 103, 95);
        myLable.font = [UIFont systemFontOfSize:kFRate(9.0f)];
        myLable.backgroundColor = IWColor(250, 241, 219);
        
        //计算文本的宽度
        CGFloat calcuWidth = [self widthForTextString:title height:labelHeight fontSize:kFRate(9.0f)];
        ...
        if (calcuWidth>frame.size.width) {
            ...
            behindLabel.textColor = IWColor(84, 103, 95);
            behindLabel.font = [UIFont systemFontOfSize:kFRate(9.0f)];
            behindLabel.backgroundColor = IWColor(250, 241, 219);
