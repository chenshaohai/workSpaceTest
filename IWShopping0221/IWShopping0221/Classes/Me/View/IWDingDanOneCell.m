...
@implementation IWDingDanOneCell
+ (instancetype)cellWithTableView:(UITableView *)tableView;
{
    NSString *ID = [NSString stringWithFormat:@"IWDingDanOneCell"];
    IWDingDanOneCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[IWDingDanOneCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
...
- (void)setModel:(IWDingDanOneModel *)model
{
    _model = model;
