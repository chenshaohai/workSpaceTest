...
-(void)initUI
{
    ...
    backImageView.image = [UIImage imageNamed:@"node"];
    ...
    // 在转盘上添加图片和文字
    _imageArray = @[@"qiandao_0000_000",@"qiandao_0001_001",@"qiandao_0002_003",@"qiandao_0003_01",@"qiandao_0004_02",@"qiandao_0000_000",@"2000",@"qiandao_0003_01"];
...
- (void)setNumberArray:(NSArray *)numberArray
{
    ...
    for (int i = 0; i < 8; i ++) {
        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(0, 0,M_PI * CGRectGetHeight(self.bounds)/8,
                                                                  CGRectGetHeight(self.bounds)/1.5)];
        ...
        label.font = [UIFont systemFontOfSize:kFRate(12)];
